...
See the [Logging into gcloud](https://cloud.google.com/anthos/gke/docs/bare-metal/1.6/installing/install-prereq#logging_into_gcloud) section of the [Installation prerequisites overview](https://cloud.google.com/anthos/gke/docs/bare-metal/1.6/installing/install-prereq) documentation for the IAM role requirements.
...
- In the cluster configuration files specified in the [Review the cluster configuration files](/docs/software-only_bare-metal_reference-architecture/scripts/deploy-to-hosts.md#review-the-cluster-configuration-files) section
